...
class Package
{
    ...
    private:    // data members to store sender and recipient's address information    
        string senderName;    
        ...
        double costPerOunce; // cost per ounce to ship t
};
...
TwoDayPackage::TwoDayPackage(const string &sName, const string &sAddress,                 
                            const string &sCity, const string &sState, int sZIP,                 
                            const string &rName, const string &rAddress, const string &rCity,                 
                            const string &rState, int rZIP, double w, double cost ,double flatfee)
:flatFee(flatfee),Package(sName,sAddress,sCity,sState,sZIP,rName,rAddress,rCity,rState,rZIP,w,cost)
{
    setFlatFee(flatfee);
}
...
OvernightPackage::OvernightPackage(const string &sName, const string &sAddress,                 
                            const string &sCity, const string &sState, int sZIP,                 
                            const string &rName, const string &rAddress, const string &rCity,                 
                            const string &rState, int rZIP, double w, double cost, double overnightfeeperounce)
:overnightFeePerOunce(overnightfeeperounce),Package(sName,sAddress,sCity,sState,sZIP,rName,rAddress,rCity,rState,rZIP,w,cost)
{
...
{
    return Package::calculateCost()+OvernightPackage::getWeight()*OvernightPackage::getOvernightFeePerOunce();
}
...
{    
    Package package1( "Lou Brown", "1 Main St", "Boston", "MA", 11111,                     
                      "Mary Smith", "7 Elm St", "NewYork", "NY", 22222, 8.5, .5 );    
    TwoDayPackage package2( "Lisa Klein", "5 Broadway", "Somerville", "MA",33333,
                            "Bob George", "21Pine Rd", "Cambridge", "MA", 44444,10.4, .65, 2.0 );    
